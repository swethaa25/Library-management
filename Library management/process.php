...
<a class="btn btn-outline-primary" href="form3.php" role="button" style="margin: 5px; " >ADD ANOTHER USER</a>
...
mysqli_query($connect,"INSERT INTO users (empcode,name,designation,email)
		        VALUES ('$empcode','$name','$designation','$email')");
